...
export default function PrivacyPage() {
  return (
    <div className="max-w-4xl -mt-12 mx-auto px-6">
      <h1 className="text-4xl font-bold mb-6 text-violet-500 text-center">
        Privacy Policy
      </h1>
      ...
      <p className="text-gray-700 mb-4">
        ...
        contact preferences when you use our services.
      </p>
      ...
      <p className="text-gray-700 mb-4">
        Your information is used to provide services, process orders, send
        updates, and improve your experience on our website.
      </p>
      ...
      <p className="text-gray-700 mb-4">
        ...
        third parties for order fulfillment and legal compliance.
      </p>
