...
const SuccessPageContent = () => {
  ...
  return (
    <div className="bg-linear-to-br -mt-12 from-gray-50 to-gray-100 flex items-center justify-center mx-4">
      <motion.div
      ...
      >
        <motion.div
          ...
          className="w-20 h-20 bg-blue-400 rounded-full flex items-center justify-center mx-auto mb-4 shadow-lg"
        >
